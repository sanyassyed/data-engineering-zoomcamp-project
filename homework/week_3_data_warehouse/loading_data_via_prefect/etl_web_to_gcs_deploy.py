...
local_dep = Deployment.build_from_flow(flow = etl_parent_flow, name='WebToGcs ETL Wk 3 HW Parquet', work_queue_name="week3p", entrypoint="etl_web_to_gcs_parquet.py:etl_parent_flow", parameters={"months":[2, 3], "years":[2019, 2020]})
